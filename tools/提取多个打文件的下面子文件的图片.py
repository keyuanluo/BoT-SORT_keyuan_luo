...
def extract_pedestrians_from_folders(big_folders_list, input_base_folder, output_base_folder):
    # 遍历每个大文件夹
...
if __name__ == "__main__":
    ...
    output_base_folder = '/media/robert/4TB-SSD/watchped_dataset - 副本/Box/'
    ...
    if len(sys.argv) == 3:
        ...
        print("用法：python script.py [输入基础路径] [输出基础路径]")
        sys.exit(1)

    extract_pedestrians_from_folders(big_folders_list, input_base_folder, output_base_folder)
