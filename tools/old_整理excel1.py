...
# 示例用法：
# 读取 Excel 文件
input_excel = '/media/robert/4TB-SSD/watchped_dataset - 副本/Excel_Box/evening 2/01_06_2023_17_07_54_scene7_stop_cross_veryfar/detections.xlsx'  # 替换为您的 Excel 文件名
df = pd.read_excel(input_excel)

track_id_list = [1,3,6,7,8,10]# 指定要处理的 track_id 列表
