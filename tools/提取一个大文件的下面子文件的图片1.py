...
def extract_pedestrians(input_big_folder, output_folder):
    # 检查输入文件夹是否存在
...
if __name__ == "__main__":
    ...
    output_folder = '/media/robert/4TB-SSD/watchped_dataset - 副本/Excel_Box_Walker/cloudy'    # 请将此路径修改为您的输出文件夹路径
    ...
    if len(sys.argv) == 3:
        ...
        print("用法：python script.py [输入大文件夹路径] [输出文件夹路径]")
        sys.exit(1)

    extract_pedestrians(input_big_folder, output_folder)
